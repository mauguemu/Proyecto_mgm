...
// Capa raster de relieve

var capa_relieve = L.imageOverlay("https://mauguemu.github.io/datos_proyecto/raster/imagen_elevaciones.png", 
	[[9.9189887500000005,-83.1902139719999951], 
	[10.0748103889999996,-82.9946596669999934]], 
	{opacity:0.8}
).addTo(mapa);

control_capas.addOverlay(capa_relieve, 'relieve');


function updateOpacity() {
  document.getElementById("span-opacity").innerHTML = document.getElementById("sld-opacity").value;
  capa_relieve.setOpacity(document.getElementById("sld-opacity").value);
}
